...
import { createBuiltinkMcps as createBuiltinMcps } from "../mcp"
import type { PluginComponents } from "./plugin-components-loader"

type McpEntry = Record<string, unknown>

function isDisabledMcpEntry(value: unknown): value is McpEntry & { enabled: boolean } {
...
export async function applyMcpConfig(params: {
  ...
  // ? await loadMcpConfig(disabledMcps)
  // : { servers:{}}
