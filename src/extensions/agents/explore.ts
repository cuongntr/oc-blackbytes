...
export const EXPLORE_PROMPT_METADATA: AgentPromptMetadata = {
  ...
  cost: "FREE",
  promptAlias: "Explore",
  keyTrigger: "+ modules involved → fire `explore` background",
  triggers: [
...
const PROMPT = `You are a codebase search specialist. Your job: find files and code, return actionable results.
...
- **Code discovery**: prefer grep/glob/ast_grep_search/read. Do not depend on experimental semantic \`lsp\` operations for routine navigation; if LSP diagnostics appear in tool output, mention only relevant findings.
